...
phylo_papers_author_network_plot <-
...
# compose the multi-plot panel
library(cowplot)
plot_grid(phylo_papers_methods_plot ,
  plot_grid(phylo_papers_author_network_plot,
            phylo_papers_per_year_plot,
            labels = c("B", "C"),
            ncol = 1,
            rel_heights = c(2, 1)
